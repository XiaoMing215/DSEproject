...
# 创建模型实例
def final_CNN(csv_path, tag, save_path):
    ...
    file_path = '../data/sgns.zhihu.bigram'
    # file_path = os.path.join(folder_path, 'sgns.zhihu.bigram')
    ...
    for sentence in sentences:
        ...
        if predicted_class == 1:
            ...
            # print("结果: 负性")
    # print("pos:", predict_list.count(1))
    # print("neg:", predict_list.count(0))
    df["tags"] = predict_list
...
if __name__ == "__main__":
    csv_path = "筛选数据_“三权分立”变“三权合一”，特朗普2.0时代前瞻 (2).csv"
    save_path = "正向负向.csv"
    final_CNN(csv_path=csv_path, tag="评论内容", save_path=save_path)
